...
describe('Authentication Flow Integration', () => {
  ...
  describe('2FA (Two-Factor Authentication) flow', () => {
    ...
    it('should handle 2FA setup flow', async () => {
      // 2FA setup is handled during sign-in
  ...
  describe('Logout flow', () => {
    ...
    it('should redirect to home after logout in free edition', async () => {
  ...
  describe('Protected routes', () => {
    it('should allow unauthenticated users in free edition', async () => {
      (getSession as jest.Mock).mockResolvedValue(null);
      const router = useRouter();
