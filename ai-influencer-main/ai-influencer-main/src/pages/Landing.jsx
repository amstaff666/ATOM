...
export default function Landing() {
  ...
  return (
    <div style={{
      ...
      background: pageStyle.background || pageStyle.backgroundColor || '#07070E',
      overflow: 'hidden',
      ...
      <div style={{ maxWidth: 680, position: 'relative', zIndex: 2 }}>
        ...
        <div style={{
          ...
          <Editable id="landing.badge" defaultText="Adrenalin Studio" />
        </div>

        <Editable
          as="h1"
          id="landing.title"
          defaultText="Create Your"
          style={{ fontSize:'clamp(62px,10vw,104px)', fontWeight:800, letterSpacing:'-3.5px', lineHeight:1.0, color:'#fff', marginBottom:2 }}
        />
        ...
        <Editable
          as="p"
          id="landing.subtitle"
          defaultText="Build, manage, and grow your AI influencers."
          style={{ fontSize:20, color:'rgba(255,255,255,0.38)', lineHeight:1.65, margin:'0 auto 52px', maxWidth:420, fontWeight:400, letterSpacing:'-0.1px' }}
        />

        <label style={{display:'inline-block'}}><input type="file" accept="image/*" multiple style={{display:'none'}} onChange={e => { /* handle upload */ }} /><Editable
          as="button"
          id="landing.cta"
          defaultText="Vali element"
          style={{
        ...
        /></label>
<div style={{ padding: 24, margin: '20px 0', borderRadius: 16, background: 'var(--bg-secondary)', border: '1px solid var(--border-subtle)' }}>
          <Editable as="h3" id="landing.insert.block.mqe2c7c2.title" defaultText="Uus plokk" style={{ fontSize: 18, fontWeight: 700, marginBottom: 8, color: 'var(--text-primary)' }} />
          <Editable as="p" id="landing.insert.block.mqe2c7c2.body" defaultText="Lisa siia sisu või kirjeldus…" style={{ fontSize: 14, lineHeight: 1.6, color: 'var(--text-secondary)' }} />

        </div>
      </div>

<div style={{ margin: '20px 0' }}>
          <Editable as="p" id="landing.insert.image.mqeas93h" defaultText="punane kleit (test)" style={{ fontSize: 13, color: 'var(--text-secondary)', marginTop: 8 }} />
        </div>
