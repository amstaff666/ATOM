...
<Editable as="h2" id="create.insert.heading.mqe27ywz" defaultText="Adrenalin Studio" style={{ fontSize: 32, fontWeight: 800, letterSpacing: '-1.5px', margin: '20px 0 12px', background: 'linear-gradient(90deg,#EC4899,#8B5CF6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />
        <p style={{ fontSize: 15, color: L.textSub, lineHeight: 1.55 }}>Start with the basics — you can always refine later.</p>
      </div>

      <div style={{ marginBottom: 22 }}>
        <Lbl>Name</Lbl>
        <input className={inputCls} style={inputStyle} value={data.name} onChange={e => set('name', e.target.value)} placeholder=" Adrenalin Studio" autoFocus />
      </div>
...
function ProviderIcon({ provider, version }) {
  ...
  return (
    <div style={{ width: 36, height: 36, borderRadius: 10, background: 'var(--bg-tertiary)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, flexShrink: 0 }}>
      {icon}
    </div>
  )
}
